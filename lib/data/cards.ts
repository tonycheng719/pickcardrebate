...
export const HK_CARDS: CreditCard[] = [
  ...
  // ========================================================================
  {
    ...
    foreignCurrencyFee: 1.95,
    rules: [
      // 手機支付/網購 4.4% (每月消費 $2,000-$5,000)
      { description: "手機支付 4.4% (月消費$2000-$5000)", matchType: "paymentMethod", matchValue: ["mobile"], percentage: 4.4, monthlyMinSpend: 2000, cap: 5000, capType: "spending", excludeCategories: ["ewallet"] },
      { description: "網購 4.4% (月消費$2000-$5000)", matchType: "category", matchValue: "online", percentage: 4.4, monthlyMinSpend: 2000, cap: 5000, capType: "spending", excludeCategories: ["ewallet"] },
      { description: "基本回饋 0.4%", matchType: "base", percentage: 0.4, excludeCategories: ["tax", "utilities", "government", "insurance"], excludePaymentMethods: ["fps"] },
    ],
    tags: ["手機支付", "網購"],
    sellingPoints: ["手機支付及網購 4.4% 回贈", "每月消費 $2,000-$5,000 享優惠"],
    note: "⚠️ 手機支付/網購 4.4% 需每月消費 $2,000-$5,000！未滿 $2,000 或超過 $5,000 部分只有 0.4%。",
  },
  {
    id: "bea-world-master",
  ...
  },
  {
    ...
    foreignCurrencyFee: 1.95,
    rules: [
      // 網上簽賬 8% (無需登記，每月回贈上限 $300)
      { description: "網上簽賬 8%", matchType: "category", matchValue: "online", percentage: 8.0, cap: 300, capType: "reward", excludeCategories: ["ewallet"] },
      { description: "基本回饋 0.4%", matchType: "base", percentage: 0.4, excludeCategories: ["tax", "utilities", "government", "insurance"], excludePaymentMethods: ["fps"] },
    ],
    tags: ["網購8%", "年輕人", "無需登記"],
