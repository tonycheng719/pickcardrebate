...
export const HK_CARDS: CreditCard[] = [
  ...
  },
  {
    ...
    sellingPoints: ["🔥 指定海外商戶 15% 回贈 [限時]", "海外簽賬 4% / $1.5/里 [需登記]", "本地餐飲 2% / $3/里 [需登記]", "免外幣手續費"],
