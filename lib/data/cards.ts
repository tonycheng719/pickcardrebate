...
export const HK_CARDS: CreditCard[] = [
  ...
  },
  {
    ...
    note: "💡 **「賞」亞洲優惠**：須在 AEON App 登記！\n\n**內地/澳門/台灣** (至2026/1/31)：15X積分 = 6%，每月上限$100回贈（即每月首$1,667簽賬享6%）。\n\n**韓國** (2025/12/1-2026/1/31)：15X積分 = 6%，每月上限$200回贈（即每月首$3,333簽賬享6%）。\n\n✅ 合資格：實體卡、Apple Pay、銀聯QR Pay、雲閃付。\n❌ 不計回贈：電子錢包（微信/支付寶/AlipayHK/WeChat Pay HK）、八達通增值。\n\n⚠️ 每月20日 AEON 95折是購物時直接減價，非事後回贈。",
