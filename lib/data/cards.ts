...
export const HK_CARDS: CreditCard[] = [
  ...
  },
  {
    ...
    welcomeOfferText: "迎新送高達 40,000 里 (簽$5,000送1萬/簽$11萬送4萬) / 🔥繳稅高達23,000里",
    sellingPoints: ["食肆/酒店/海外簽賬 HK$4/里", "八達通增值計里數", "🔥 迎新簽$5,000即送10,000里 ($0.5/里)", "🔥 繳稅高達23,000里 (2025/11-2026/2)"],
    note: "## 📌 迎新優惠（至 2026/1/15）\n\n發卡後首 **2 個月**內簽賬（階梯制，只計最高一級）：\n\n| 等級 | 累積簽賬 | 獎賞 | 平均 $/里 |\n|:---:|:---:|:---:|:---:|\n| 1️⃣ | $5,000 | **10,000里** | $0.5/里 🔥 |\n| 2️⃣ | $40,000 | **20,000里** | $2/里 |\n| 3️⃣ | $110,000 | **40,000里** | $2.75/里 |\n\n✅ 合資格簽賬：零售購物（本地+海外）、網上消費、分期付款\n❌ 不計：現金透支、賭博、保費、八達通增值、繳費、P2P轉賬\n\n---\n\n⚠️ 基本比率 $6/里。【指定類別 $4/里】食肆（港幣）、酒店（港幣）、海外（外幣）。✅ 八達通自動增值計里數！💳 外幣手續費 1.95%。\n\n🔥 **繳稅優惠**（2025/11/18-2026/2/2）：[查看詳情](/discover/sc-tax-payment-2025)",
  ...
  },
  {
    ...
    note: "## 📌 餐飲及旅遊簽賬 10X 積分優惠\n**推廣期：2026/1/1 - 2026/6/30**\n\n| 簽賬類別 | 積分 | 回贈 | 每月上限 |\n|:---|:---:|:---:|:---:|\n| 本地餐飲 | 10X | 4% | $10,000 |\n| 外幣零售 | 10X | 4% | $25,000 |\n| **合共** | - | - | **$30,000** |\n\n⚠️ **條件**：月簽滿 $5,000 方可享用\n❌ **不適用**：BoC Pay+、AlipayHK、WeChat Pay、PayMe\n\n---\n\n## ✈️ 狂賞飛 2026（需另外登記）\n**推廣期：2026/1/1 - 6/30（分2季）**\n\n| 地區 | 每季簽滿 | 回贈 | 疊加 Cheers 4% |\n|:---|:---:|:---:|:---:|\n| 🇨🇳🇲🇴 內地/澳門 | $5,000 | 6% ($300) | **10%** 🔥 |\n| 🌍 其他海外 | $10,000 | 3% ($300) | **7%** |\n\n👉 [立即登記狂賞飛](https://iservice.boccc.com.hk/LDPRegistrationWEB/w-verify.jsp?lang=zh_HK&action=register&campaignid=fly2601)\n\n---\n\n## 🎁 其他權益\n- ✈️ **免費旅遊保險**：凴卡支付機票/酒店/套票，即享高達 $780萬人身意外保障\n- 🎫 **機場貴賓室**：每季度簽滿 $15,000 可享免費2次\n- 🍽️ **高級餐廳買一送一**：指定套餐\n\n---\n\n📅 **2026年1月1日更新**：新增狂賞飛疊加",
    promoEndDate: "2026-06-30",
    promoName: "餐飲及旅遊簽賬 10X 積分優惠 + 狂賞飛",
  },
  {
  ...
  // ========================================================================
  {
    ...
    tags: ["全方位2%", "懶人必備", "銀聯1%手續費", "八達通0.4%", "🔥中澳台日韓7%"],
  ...
  },
  {
    ...
    foreignCurrencyFee: 1, // 2025/1/1 起銀聯卡外幣手續費 1%
    rules: [
      // 🔥 本地餐飲優惠 (2025/12/29 - 2026/1/31) - 只適用於網上申請嘅全新迎新客戶
      // 實體卡：9.6% 推廣 + 0.4% 基本 = 10%（唔使月簽$1,500）
      // 手機支付夠$1,500：6% 推廣 + 3.6% 手機支付類別 + 0.4% 基本 = 10%
      // 手機支付唔夠$1,500：6% 推廣 + 0.4% 基本 = 6.4%
      // 單一簽賬滿 $100，全期上限 $500 額外回贈
      { description: "🔥餐飲 10% [實體卡,單筆≥$100,唔使月簽$1500]", matchType: "category", matchValue: "dining", percentage: 10.0, minSpend: 100, cap: 500, capType: "reward", validDateRange: { start: "2025-12-29", end: "2026-01-31" }, excludePaymentMethods: ["mobile", "apple_pay", "unionpay_qr", "octopus", "alipay", "wechat_pay", "payme"] },
      { description: "🔥餐飲 10% [手機支付,需月簽$1,500]", matchType: "category", matchValue: "dining", percentage: 10.0, minSpend: 100, monthlyMinSpend: 1500, cap: 500, capType: "reward", validDateRange: { start: "2025-12-29", end: "2026-01-31" }, excludePaymentMethods: ["octopus", "alipay", "wechat_pay", "payme"] },
      { description: "🔥餐飲 6.4% [手機支付,唔夠月簽$1,500]", matchType: "category", matchValue: "dining", percentage: 6.4, minSpend: 100, cap: 500, capType: "reward", validDateRange: { start: "2025-12-29", end: "2026-01-31" }, excludePaymentMethods: ["octopus", "alipay", "wechat_pay", "payme"] },
    ...
    tags: ["玩樂4%", "旅遊", "海外", "線上娛樂", "八達通增值", "銀聯1%手續費", "餐飲10%", "🔥中澳台日韓9%"],
    welcomeOfferText: "迎新簽$8,500送$500 / 簽$8,800送LG顯示器或Marshall喇叭 + 高達$90,000免息套現",
  ...
  },
  {
    ...
    rules: [
      ...
      { description: "🔥餐飲 10% [實體卡,唔使月簽$1500]", matchType: "category", matchValue: "dining", percentage: 10.0, minSpend: 100, cap: 500, capType: "reward", validDateRange: { start: "2025-12-29", end: "2026-01-31" }, excludePaymentMethods: ["mobile", "apple_pay", "octopus", "alipay", "wechat_pay", "payme"] },
      { description: "🔥餐飲 10% [Apple Pay,需月簽$1,500]", matchType: "category", matchValue: "dining", percentage: 10.0, minSpend: 100, monthlyMinSpend: 1500, cap: 500, capType: "reward", validDateRange: { start: "2025-12-29", end: "2026-01-31" }, excludePaymentMethods: ["octopus", "alipay", "wechat_pay", "payme"] },
      { description: "🔥餐飲 6.4% [Apple Pay,唔夠月簽$1,500]", matchType: "category", matchValue: "dining", percentage: 6.4, minSpend: 100, cap: 500, capType: "reward", validDateRange: { start: "2025-12-29", end: "2026-01-31" }, excludePaymentMethods: ["octopus", "alipay", "wechat_pay", "payme"] },
      // T&C 2025/7/1-2026/6/30: 玩樂類別 4 選 1，需月簽$1,500，每月回贈上限 $200
