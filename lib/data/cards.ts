...
export const HK_CARDS: CreditCard[] = [
  ...
  // ========================================================================
  {
    ...
    sellingPoints: ["永久免年費", "海外 6% (月簽上限$8,333)", "網上 5% (月簽上限$10,000)", "回贈上限 $500/月 (共用)", "八達通自動增值 0.4%", "🔥冬日簽賬賞額外高達$2,800"],
  ...
  },
  {
    ...
    sellingPoints: ["🔥2026新條款：只限實體店", "指定國家 7% (月簽上限$7,143)", "其他外幣/餐飲 5% (月簽上限$10,000)", "回贈上限 $500/月"],
  ...
  // ========================================================================
  {
    ...
    sellingPoints: ["🔥旅遊/交通 6.4% (月簽上限$3,125)", "娛樂 5.4% (月簽上限$3,704)", "手機/網上 4.4% (月簽上限$4,545)", "回贈上限 $200/月 (共用)"],
  ...
  },
  {
    ...
    sellingPoints: ["🔥中澳台日韓 9% [需登記]", "玩樂 4% (月簽上限$5,000)", "回贈上限 $200/月", "🎓 學生可申請", "銀聯外幣僅 1%"],
  ...
  },
  {
    ...
    officialApplyUrl: "https://www.primecredit.com/tc/credit-card/wewa/",
    applyUrl: "https://apply.creatory.moneyhero.com.hk/click?o=180&a=228&sub_id1=pickcardrebate&sub_id2=web",
    sellingPoints: ["玩樂 4% (月簽上限$5,000)", "回贈上限 $200/月", "🎓 學生可申請", "Visa Signature 禮遇", "月簽 $1,500 門檻"],
  ...
  // ========================================================================
  {
    ...
    sellingPoints: ["食肆及網上 6% (月簽上限$3,670)", "回贈上限 $200/月", "需月簽滿 $3,800 先有 6%", "永久免年費"],
