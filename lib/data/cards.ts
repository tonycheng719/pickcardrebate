...
export const HK_CARDS: CreditCard[] = [
  ...
  },
  {
    ...
    sellingPoints: ["食肆/酒店/海外簽賬 HK$4/里", "八達通增值計里數", "🔥 簽$10萬送20會籍積分 (2025全年)", "9折里數兌換酒店/租車/餐膳獎勵"],
    note: "⚠️ 基本比率 $6/里。【2025年指定類別 $4/里】食肆（港幣）、酒店（港幣）、海外（外幣）。✅ 八達通自動增值計里數！💳 外幣手續費 1.95% (Mastercard 1% + 銀行 0.95%)。⚠️ 跨境港幣交易收取 1% 徵費！❌ 不計里數：保費、繳稅（日常）、FPS、支付寶/八達通錢包增值、網上理財繳費、電話/郵購、賭博、金融機構交易、P2P轉賬。⚠️ 食肆限制：不包括酒席宴會、私人派對、酒店/美食廣場/超市/百貨公司內食肆。⚠️ 酒店限制：須直接於酒店或官網簽賬，不包括第三方平台（如Agoda/Booking.com）。年費：$2,000（首年豁免），優先理財($100萬+)/Premium理財($20萬+)/出糧客戶免年費。【會籍積分推廣 2025全年】每簽$100,000送20會籍積分，上限100積分！【FanFest禮遇 2025/10/31-2026/1/15】全新客戶繳稅$4/里（上限20,000里）！【出糧客戶禮遇】額外 2,000 里。",
  ...
  // ========================================================================
  {
    ...
    rules: [
      ...
      { description: "本地餐飲/外賣 4% (需登記,月簽<$8k)", matchType: "category", matchValue: ["dining"], percentage: 4.0, cap: 800, capType: "reward", excludePaymentMethods: ["alipay", "wechat_pay", "payme", "octopus"] },
