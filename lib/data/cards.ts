...
export const HK_CARDS: CreditCard[] = [
  ...
  // ========================================================================
  {
    ...
    sellingPoints: ["永久免年費", "海外 6% (簽上限$8,333/月)", "網上 5% (簽上限$10,000/月)", "回贈上限 $500/月 (共用)", "⚠️ 簽賬門檻 $5,000/月", "🔥冬日簽賬賞額外高達$2,800"],
  ...
  },
  {
    ...
    sellingPoints: ["🔥2026新條款：只限實體店", "指定國家 7% (簽上限$7,143/月)", "其他外幣/餐飲 5% (簽上限$10,000/月)", "回贈上限 $500/月", "⚠️ 簽賬門檻 $6,000/月"],
  ...
  // ========================================================================
  {
    ...
    sellingPoints: ["🔥旅遊/交通 6.4% (簽上限$3,125/月)", "娛樂 5.4% (簽上限$3,704/月)", "手機/網上 4.4% (簽上限$4,545/月)", "回贈上限 $200/月 (共用)", "⚠️ 簽賬門檻 $2,000/月"],
  ...
  // ========================================================================
  {
    ...
    sellingPoints: ["全方位 2% (年簽上限$150,000)", "回贈上限 $1,500/年 (加碼)", "🔥中澳台日韓 7% [需登記]", "銀聯外幣僅 1%", "Apple Pay 手動增值八達通 2%"],
  ...
  },
  {
    ...
    sellingPoints: ["🔥中澳台日韓 9% [需登記]", "玩樂 4% (簽上限$5,000/月)", "回贈上限 $200/月", "⚠️ 簽賬門檻 $1,500/月", "🎓 學生可申請"],
  ...
  },
  {
    ...
    officialApplyUrl: "https://www.primecredit.com/tc/credit-card/wewa/",
    applyUrl: "https://apply.creatory.moneyhero.com.hk/click?o=180&a=228&sub_id1=pickcardrebate&sub_id2=web",
    sellingPoints: ["玩樂 4% (簽上限$5,000/月)", "回贈上限 $200/月", "⚠️ 簽賬門檻 $1,500/月", "🎓 學生可申請", "Visa Signature 禮遇"],
  ...
  // ========================================================================
  {
    ...
    sellingPoints: ["食肆/網上 6% (簽上限$3,670/月)", "回贈上限 $200/月", "⚠️ 簽賬門檻 $3,800/月 (高過上限!)", "永久免年費"],
    note: "## 📌 食肆及網上簽賬 6% 現金回贈\n**推廣期：2026/1/1 - 2026/6/30**\n\n### 💳 回贈率及上限\n| 簽賬類別 | 回贈率 | 簽賬上限 | 回贈上限 |\n|:---|:---:|:---:|:---:|\n| 食肆 | **6%** | $3,670 | $200 |\n| 網上 | **6%** | $3,670 | $200 |\n| 其他 | 0.55% | 無上限 | - |\n\n⚠️ 食肆+網上 **共用 $200 回贈上限**\n\n---\n\n## ⚠️ 下限高過上限問題\n\n| 項目 | 金額 |\n|:---|:---:|\n| 月簽下限 | $3,800（需簽滿先有 6%）|\n| 簽賬上限 | $3,670（已爆回贈上限）|\n| 差額 | $130（只有 0.55% 基本回贈）|\n\n即係簽 $3,800 先有 6%，但 $200 回贈上限喺 $3,670 已經爆 Cap！\n\n---\n\n## ❌ 不計簽賬\n- 酒店餐飲、美食廣場/超市/百貨公司內食肆、麵包房、糕點商店\n- 超級市場網上平台\n- 電子錢包（支付寶/微信支付/PayMe/轉數快）\n- 八達通增值\n\n---\n\n📅 **2026年1月7日更新**",
  ...
  },
  {
    ...
    sellingPoints: ["🔥 網購 8% (月簽上限$2,500)", "🚌 交通 8% (港鐵/巴士/電車)", "👨‍🎓 學生可申請", "回贈上限 $200/月，$600/推廣期"],
  ...
  },
  {
    ...
    sellingPoints: ["🔥 網購 8% (月簽上限$2,500)", "✈️ 海外實體店 8%", "指定商戶 3%", "回贈上限 $200/月，$600/推廣期"],
