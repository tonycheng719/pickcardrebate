...
export const POPULAR_MERCHANTS: Merchant[] = [
  ...
  { id: "general-online", name: "一般網上簽賬", categoryIds: ["online"], aliases: ["網購", "online"], logo: "🌐", accentColor: "#3b82f6", isGeneral: true },
  ...
  { id: "hktvmall", name: "HKTVmall", categoryIds: ["online", "supermarket"], aliases: ["hktv", "王維基"], logo: "📺", accentColor: "#65a30d" },
  ...
  { id: "deliveroo", name: "Deliveroo 戶戶送", categoryIds: ["dining", "online"], aliases: ["外賣", "deliveroo"], logo: "🛵", accentColor: "#06b6d4" },
  { id: "foodpanda", name: "foodpanda", categoryIds: ["dining", "online"], aliases: ["熊貓", "foodpanda"], logo: "🐼", accentColor: "#ec4899" },
  ...
  { id: "ird", name: "Inland Revenue Department 稅務局", categoryIds: ["tax", "government"], aliases: ["稅", "交稅", "ird", "tax"], logo: "📄", accentColor: "#4b5563" },
  { id: "clp", name: "CLP 中電", categoryIds: ["utilities"], aliases: ["電費", "中電", "clp"], logo: "⚡️", accentColor: "#2563eb" },
  { id: "payme", name: "PayMe", categoryIds: ["ewallet"], aliases: ["payme", "增值"], logo: "💖", accentColor: "#ec4899" },
