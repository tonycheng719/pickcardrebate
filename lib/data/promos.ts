...
`,
  ...
  {
    id: "dining-2026",
    title: "🍽️ 2026 餐飲信用卡排行榜｜最高 9% 回贈！食飯碌邊張卡最抵？",
    merchant: "攻略文章",
    description: "出街食飯邊張卡最抵？本文比較香港各大信用卡餐飲回贈率，由 9% 到 2%，仲有限時優惠！一文睇清 2026 年最新排行榜！",
    imageUrl: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?q=80&w=2070&auto=format&fit=crop",
    expiryDate: "2026-12-31",
    relatedCardIds: ["ccb-eye", "aeon-visa", "aeon-mastercard", "cncbi-motion", "dbs-eminent", "hangseng-travel-plus", "boc-cheers", "hsbc-vs", "citi-cashback", "earnmore", "mox-credit"],
    tags: ["攻略", "餐飲", "排行榜", "食飯", "2026"],
    url: "",
    updatedAt: "2026-01-05",
    isPinned: true,
    content: \`
...
出街食飯想賺最多回贈？以下整理咗全港信用卡餐飲回贈排行榜，由高至低排列！

---

## 📊 餐飲回贈總覽

| 排名 | 信用卡 | 回贈率 | 月簽上限 | 入場門檻 | 特點 |
|:---:|:---|:---:|:---:|:---|:---|
| 1 | **建行eye卡** | **9%+2%** | $4,445 | 月簽$5,000 + 單筆$300 | 🔥加碼賞，需登記 |
| 2 | **AEON Card Purple** | **6%** | $1,786 | 無 | 需手機支付 + 登記 |
| 3 | **信銀Motion** | **6%** | $3,636 | 月簽$3,800 | ⚠️下限高過上限 |
| 4 | **DBS Eminent** | **5%** | $8,000 | 單筆$300 | 需登記 |
| 5 | **恒生Travel+** | **5%** | $10,870 | 月簽$6,000 | 需登記 |
| 6 | **東亞World MC** | **5%** | $10,000 | 月簽$4,000 | 需登記 |
| 7 | **中銀Cheers** | **4%** | $10,000 | 月簽$5,000 | 餐飲+海外 |
| 8 | **滙豐VS** | **3.6%** | $100,000/年 | 無 | 需自選賞滋味 |
| 9 | **Citi Cash Back** | **2%** | 無上限 | 無 | 簡單直接 |
| 10 | **Mox Credit** | **2%** | 無上限 | 存款$25萬 | 高存款用戶 |
| 11 | **安信EarnMORE** | **2%** | $80,000/半年 | 無 | 全方位回贈 |
...
**適合人士：** 每月餐飲簽賬 $3,000-$5,000、願意每月登記的用戶

👉 [查看建行 eye 卡詳情](/cards/ccb-eye)

---

### 🥈 AEON Card Purple（Visa/Mastercard/JCB/銀聯）
...
**缺點：**
- ❌ 必須用 Apple Pay/Google Pay 付款
- ❌ 上限只有 $1,786
- ❌ 不計網上平台（如外賣 App）

**適合人士：** 每月餐飲簽賬 < $2,000、習慣手機支付的用戶

👉 [查看 AEON Visa 詳情](/cards/aeon-visa) | [查看 AEON Mastercard 詳情](/cards/aeon-mastercard)
...
**缺點：**
- ❌ 月簽門檻 $3,800 較高
- ❌ ⚠️ 下限高過上限！需簽 $3,800 但 $3,636 已爆 cap

**適合人士：** 每月總簽賬 > $4,000（餐飲 + 網購）的用戶

👉 [查看信銀 Motion 詳情](/cards/cncbi-motion)
...
| 餐飲回贈 | **5%** |
| 單筆最低 | $300 |
| 月簽上限 | $8,000（Visa Signature）|
| 需登記 | ✅ 需透過 DBS Card+ App 登記 |
...
👉 [查看 DBS Eminent 詳情](/cards/dbs-eminent)

---

### 恒生 Travel+ Visa Signature
...
👉 [查看恒生 Travel+ 詳情](/cards/hangseng-travel-plus)
...
👉 [查看東亞 World MC 詳情](/cards/bea-world-master)
...
👉 [查看中銀 Cheers 詳情](/cards/boc-cheers)
...
👉 [查看 Citi Cash Back 詳情](/cards/citi-cashback)
...
| 月簽金額 | 推薦信用卡 |
|:---|:---|
| < $2,000 | AEON Card Purple（6%，手機支付）|
| $2,000-$4,000 | 建行 eye（需登記 + 簽滿$5,000）|
| $4,000-$6,000 | 信銀 Motion（6%）|
| > $6,000 | 恒生 Travel+（5%，上限高）|
| 任何金額 | Citi Cash Back（2%，無上限）|

### 多卡配合

**策略 1：先高後低**
1. 建行 eye 卡（簽 $4,445 爆 cap）
2. AEON Card Purple（簽 $1,786 爆 cap）
3. Citi Cash Back（無上限補底）

**策略 2：簡單無腦**
- Citi Cash Back 或安信 EarnMORE（2% 無上限）
...
\`,
    faqs: [
      { question: "餐飲回贈邊張卡最高？", answer: "建行 eye 卡加碼賞最高 9%+2%=11%，但需每月登記、月簽 $5,000、單筆 $300。無門檻的話，AEON Card Purple 有 6%（需手機支付）。" },
      { question: "AEON Card Purple 係咩卡？", answer: "AEON Card Purple 係 AEON Visa、Mastercard、JCB、銀聯嘅統稱，呢幾張卡都可以享用「紫賞生活優惠」餐飲 6% 回贈。" },
      { question: "信銀 Motion 點解「下限高過上限」？", answer: "信銀 Motion 需月簽 $3,800 先有 6%，但額外回贈上限 $200（即 $3,636 簽賬已爆 cap）。所以簽 $3,800 時，最後 $164 只有 0.55% 基本回贈。" },
      { question: "外賣 App 計唔計餐飲回贈？", answer: "大部份卡嘅「餐飲」係指實體餐廳，網上外賣 App（如 Deliveroo、Foodpanda）會計入「網上簽賬」。滙豐 Red 卡網購 4% 適用於外賣 App。" },
      { question: "酒店餐廳計唔計？", answer: "大部份卡不計酒店/百貨公司/會所內食肆。簽賬前建議確認商戶類別代碼（MCC）。" },
    ],
  },
  // ========== 🔥 最新優惠（置頂） ==========
  {
