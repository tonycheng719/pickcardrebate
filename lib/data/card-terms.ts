...
export const cardTerms: CardTerms[] = [
  ...
  // ========================================================================
  // 美國運通 Explorer 信用卡積分計劃
  // 來源：https://www.americanexpress.com/content/dam/amex/hk/ch/staticassets/pdf/cards/explorer-credit-card/MRTnC_CHI.pdf
  // ========================================================================
  {
    cardId: "amex-explorer-rewards",
    cardName: "美國運通 Explorer 信用卡積分計劃",
    bank: "美國運通",
    applicableCards: [
      { cardId: "amex-explorer", cardName: "美國運通 Explorer 信用卡" },
    ],
    documentName: "美國運通 Explorer 信用卡積分計劃條款及細則",
    rewardRates: [
      { 
        category: "本地簽賬（毋須登記）", 
        totalRate: 3, 
    ...
    warnings: [
      "📌 積分可 **免手續費** 轉換至多個飛行常客計劃",
      "📌 1積分 = 1里（亞洲萬里通、國泰、英航等）",
      "📌 附屬卡簽賬計入主卡賬戶累積",
      "📌 退款時積分調整按最新賺取倍數計算",
    ],
    officialSource: "https://www.americanexpress.com/content/dam/amex/hk/ch/staticassets/pdf/cards/explorer-credit-card/MRTnC_CHI.pdf",
    lastUpdated: "2026-01-08",
  },

  // ========================================================================
  // 美國運通 Explorer 信用卡 - 外幣及旅遊簽賬優惠
  // 來源：https://www.americanexpress.com/content/dam/amex/hk/ch/staticassets/pdf/cards/explorer-credit-card/MRTnC_CHI.pdf
  // ========================================================================
  {
    cardId: "amex-explorer-fx-travel",
    cardName: "美國運通 Explorer 信用卡 - 外幣及旅遊簽賬優惠",
    bank: "美國運通",
    applicableCards: [
      { cardId: "amex-explorer", cardName: "美國運通 Explorer 信用卡" },
    ],
    documentName: "外幣及旅遊簽賬高達10.75倍積分",
    promoStartDate: "2026-01-02",
    promoEndDate: "2026-06-30",
    rewardCap: {
      type: "extra",
      amount: 70000,
      period: "quarterly",
      note: "優惠2每季首$10,000外幣/旅遊簽賬享7X額外積分",
    },
    rewardRates: [
      { 
        category: "外幣簽賬（登記優惠1+2）", 
        totalRate: 10.75, 
        baseRate: 3, 
        extraRate: 7.75, 
        note: "高達 **10.75倍積分**（3基本+0.75+7）🔥🔥 [需登記]" 
      },
      { 
        category: "航空公司直接訂機票（登記優惠1+2）", 
        totalRate: 10.75, 
        baseRate: 3, 
        extraRate: 7.75, 
        note: "高達 **10.75倍積分**（港幣簽賬）🔥🔥 [需登記]" 
      },
      { 
        category: "指定網上旅遊商戶（登記優惠1+2）", 
        totalRate: 10.75, 
        baseRate: 3, 
        extraRate: 7.75, 
        note: "高達 **10.75倍積分**（港幣簽賬）🔥🔥 [需登記]" 
      ...
      { 
        category: "外幣/旅遊（只登記優惠1）", 
        totalRate: 3.75, 
        baseRate: 3, 
        extraRate: 0.75, 
        note: "3.75倍積分（超過每季$10,000後）[需登記]" 
      },
    ],
    exclusions: [
      "第三方付款進行的交易（電子錢包、授權零售商、轉售商）",
      "透過第三方旅行社訂購的交易",
      "包機或租賃私人飛機",
      "航空公司預訂之旅行套票、旅行團或遊輪假期",
      "航空公司預訂住宿、租車或遊輪",
      "航機上購物、飛行常客計劃",
      "成功登記前的任何簽賬",
      "未過賬/取消/退款的交易",
    ...
    warnings: [
      "📌 **需登記**：go.amex/fxspend-zh",
      "📌 優惠2每季首 **$10,000** 外幣/旅遊簽賬享7X額外積分",
      "📌 超過$10,000後只享0.75X額外積分",
      "📌 額外積分於簽賬後15個工作天內或優惠期結束後90天內存入",
      "⚠️ 以港幣付款的網上交易**不算**外幣簽賬",
    ],
    officialSource: "https://www.americanexpress.com/content/dam/amex/hk/ch/staticassets/pdf/cards/explorer-credit-card/MRTnC_CHI.pdf",
    lastUpdated: "2026-01-08",
  },
  ...
  // ========================================================================
  // 美國運通 Explorer 信用卡 - 5X積分優惠（指定網上商戶）
  // 來源：https://www.americanexpress.com/content/dam/amex/hk/ch/staticassets/pdf/cards/explorer-credit-card/MRTnC_CHI.pdf
  // ========================================================================
  {
    cardId: "amex-explorer-5x-online",
    cardName: "美國運通 Explorer 信用卡 - 指定網上商戶5X積分",
    bank: "美國運通",
    applicableCards: [
      { cardId: "amex-explorer", cardName: "美國運通 Explorer 信用卡" },
    ],
    documentName: "2026指定網上商戶5倍積分",
    promoStartDate: "2026-01-02",
    promoEndDate: "2026-12-31",
    rewardCap: {
      type: "extra",
    ...
    rewardRates: [
      { 
        category: "指定網上商戶（港幣簽賬）", 
        totalRate: 5, 
        baseRate: 3, 
        extraRate: 2, 
        note: "**5倍積分**（3基本+2額外）🔥 [需登記]" 
      },
      { 
        category: "香港淘寶App（中文版）", 
        totalRate: 5, 
        baseRate: 3, 
        extraRate: 2, 
        note: "**5倍積分** 🔥 [需登記]" 
    ...
    exclusions: [
      "實體店交易",
      "淘寶閃購、淘工廠、阿里健康、淘票票",
      "司法拍賣、天貓國際、天貓超市、閑魚集市、飛豬商品",
      "第三方付款進行的交易（電子錢包、授權零售商）",
      "通過應用程式商店或電訊服務供應商進行的交易",
      "成功登記前的任何簽賬",
      "未過賬/取消/退款的交易",
    ],
    warnings: [
      ...
      "📌 每季額外積分上限 **90,000積分**",
      "📌 指定網上商戶名單會不時更新",
      "📌 須於香港網站（.com.hk/.hk/hk）或App簽賬，且以港幣結算",
      "📌 額外積分於簽賬後15個工作天內或優惠期結束後90天內存入",
    ],
    officialSource: "https://www.americanexpress.com/content/dam/amex/hk/ch/staticassets/pdf/cards/explorer-credit-card/MRTnC_CHI.pdf",
    lastUpdated: "2026-01-08",
  ...
  // ========================================================================
  // 美國運通 Explorer 信用卡 - 機場貴賓室禮遇
  // 來源：https://www.americanexpress.com/zh-hk/travel/plaza-network/index.html
  // ========================================================================
  {
    cardId: "amex-explorer-lounge",
    cardName: "美國運通 Explorer 信用卡 - 機場貴賓室禮遇",
    bank: "美國運通",
    applicableCards: [
      { cardId: "amex-explorer", cardName: "美國運通 Explorer 信用卡" },
    ],
    documentName: "美國運通專享環亞機場貴賓室禮遇",
    promoStartDate: "2026-01-01",
    rewardRates: [
      { 
        category: "基本卡會員 - 基本次數", 
      ...
      { 
        ...
        baseRate: 0, 
        extraRate: 0, 
        note: "每年免費 **1次** 貴賓室/指定餐廳餐飲" 
      },
      { 
        category: "基本卡會員 - 累積簽$30,000後", 
        totalRate: 0, 
        baseRate: 0, 
        extraRate: 0, 
        note: "額外 **5次**（即全年最多8次）🔥" 
    ...
    minSpend: {
      amount: 30000,
      period: "annual",
      note: "累積簽$30,000解鎖額外次數",
    },
    warnings: [
      "📌 每賬戶每年最多 **12次**（1基本卡8次 + 2附屬卡各2次）",
      "📌 可選擇貴賓室**或**指定機場餐廳免費餐飲（每日一次）",
      "📌 指定餐廳包括：香港Intervals天際酒吧、TGM、峇厘Flight Club等",
      "📌 須出示合資格卡及當日/翌日登機證",
      "⚠️ 年費、外幣費用、現金透支、結餘轉戶不計入合資格簽賬",
    ],
    officialSource: "https://www.americanexpress.com/zh-hk/travel/plaza-network/index.html",
    lastUpdated: "2026-01-08",
  },

  // ========================================================================
  // 美國運通 Explorer 信用卡迎新優惠
  // 來源：https://www.americanexpress.com/content/dam/amex/hk/ch/campaigns/explorer-credit-card/Explorer_BAUWelcomeOffer_TnC_CH.pdf
  // ========================================================================
  {
    cardId: "amex-explorer-welcome",
    cardName: "美國運通 Explorer 信用卡迎新優惠",
    bank: "美國運通",
    applicableCards: [
      { cardId: "amex-explorer", cardName: "美國運通 Explorer 信用卡" },
    ],
    documentName: "美國運通 Explorer 信用卡迎新優惠條款及細則",
    promoStartDate: "2025-07-15",
    promoEndDate: "2026-02-28",
    rewardRates: [
      { 
        category: "首次簽賬獎賞", 
      ...
      { 
        ...
        baseRate: 0, 
        extraRate: 0, 
        note: "批核後首3個月累積簽賬滿$7,000 = **126,000積分** 🔥🔥" 
      },
      { 
        category: "迎新總積分（首次+簽賬）", 
        totalRate: 0, 
        baseRate: 0, 
        extraRate: 0, 
        note: "合共 **144,000積分**（= 144,000里）" 
      },
      { 
        category: "本地簽賬6倍積分（首3個月）", 
        totalRate: 6, 
        baseRate: 3, 
        extraRate: 3, 
        note: "批核後首3個月本地港幣簽賬每$1 = 6積分，高達1,152,000分 🔥🔥" 
      },
    ],
    minSpend: {
      amount: 7000,
      period: "promo",
      note: "批核後首3個月累積簽賬$7,000獲126,000迎新積分",
    },
    rewardCap: {
      type: "extra",
      amount: 1152000,
      period: "promo",
      note: "首3個月6倍積分上限1,152,000分（即$192,000簽賬）",
    },
    exclusions: [
      "購買及/或充值儲值支付工具或卡（包括電子錢包增值）",
      "本地拍賣行港幣交易",
      "美國運通卡年費、結餘轉戶",
      "購買美國運通旅行支票/禮券",
      "財務費用、過期付款附加費、追討欠賬費用",
    ...
    warnings: [
      "📌 **需網上申請**：經指定連結申請",
      "📌 須於遞交申請表 **7個工作天** 內提交所有所需文件",
      "📌 積分於簽賬後 **8星期內** 存入",
      "⚠️ 現有/過去12個月內持有任何美國運通卡者**不適用**",
      "⚠️ 批核後 **12個月內取消卡** 會扣除迎新優惠價值",
      "📋 年費$2,200（首年豁免），年簽滿$150,000可豁免下年度年費",
      "📋 最低年收入要求：$150,000",
    ],
  ...
  // ========================================================================
  // Mox Credit「EARNINMOXMH」邀請碼推廣
  // 來源：Mox Bank 官方條款
  // ========================================================================
  {
    cardId: "mox-credit-earninmoxmh-promo",
    cardName: "Mox Credit「EARNINMOXMH」邀請碼推廣",
    bank: "Mox Bank",
    applicableCards: [
      { cardId: "mox-credit", cardName: "Mox Credit 信用卡" },
    ],
    documentName: "Mox Credit「EARNINMOXMH」邀請碼推廣條款及細則",
    promoStartDate: "2025-10-24",
    promoEndDate: "2025-12-04",
    rewardRates: [
      { 
        category: "Mox Card 獎賞加成（批核後60天）", 
        totalRate: 0, 
        baseRate: 0, 
        extraRate: 0, 
        note: "無論實際存款多少，均可享 **HKD250,000 合資格結餘** 的 Mox Card 獎賞 🔥🔥" 
      },
      { 
        category: "合作夥伴消費獎賞（MoneyHero）", 
        totalRate: 0, 
        baseRate: 0, 
        extraRate: 0, 
        note: "批核後60天內 Mox Credit 消費滿 **$4,000** 獲 MoneyHero 迎新禮品兌換碼 🔥" 
      },
    ],
    minSpend: {
      amount: 4000,
      period: "promo",
      note: "批核後60天內 Mox Credit 消費滿$4,000獲合作夥伴獎賞",
    },
    exclusions: [
      "電子錢包充值（如 Apple Pay 增值八達通）",
      "不合資格獲得 Mox 卡獎賞的交易",
      "未結算/取消/退款的交易",
    ],
    warnings: [
      ...
      "📌 **申請流程**：",
      "   1️⃣ 使用邀請碼開立 Mox 戶口",
      "   2️⃣ 使用邀請碼當天起 **15天內** 完成開戶",
      "   3️⃣ 開戶日期起 **30天內** 申請並獲批 Mox Credit",
      "📌 獎賞期：Mox Credit 批核日起 **60天**",
      "⚠️ 開戶日期前 **12個月內** 不能曾持有 Mox 戶口",
      "⚠️ 開戶後 **12個月內取消** 戶口會扣除獎賞價值",
      "⚠️ 如卡獎賞的合資格結餘已達$250,000，不會獲額外獎賞",
      "⚠️ 轉換消費獎賞計劃需收費（如結餘少於$250,000）",
    ],
    officialSource: "https://www.mox.com/",
    lastUpdated: "2026-01-08",
  },

  // ========================================================================
  // sim Credit Card / sim World Mastercard® 迎新推廣優惠
  // 來源：https://cdn.thesim.com/24_Terms_and_Conditions_of_Welcome_Offer_TC_R2_78a74d748e.pdf
  // ========================================================================
  {
    cardId: "sim-credit-card-welcome",
    cardName: "sim Credit Card / sim World Mastercard® 迎新推廣優惠",
    bank: "亞洲聯合財務",
    applicableCards: [
      { cardId: "sim-credit-card", cardName: "sim Credit Card" },
      { cardId: "sim-world-mastercard", cardName: "sim World Mastercard®" },
    ],
    documentName: "sim Credit Card / sim World Mastercard® 迎新推廣優惠條款及細則",
    promoStartDate: "2026-01-01",
    promoEndDate: "2026-01-31",
    rewardRates: [
      { 
        category: "sim Credit Card 迎新（簽$4,000）", 
        totalRate: 0, 
        baseRate: 0, 
        extraRate: 0, 
        note: "**$200現金回贈** / $200 Apple Store禮品卡 / $500 Netflix禮品卡（三選一）🔥" 
      },
      { 
        category: "sim World Mastercard® 迎新（簽$8,000）", 
        totalRate: 0, 
        baseRate: 0, 
        extraRate: 0, 
        note: "**$700現金回贈** / $700 Apple Store禮品卡（二選一）🔥🔥" 
      },
      { 
        category: "實物禮品選項（簽$8,000）", 
        totalRate: 0, 
        baseRate: 0, 
        extraRate: 0, 
        note: "Canon SELPHY QX20 小型流動無線相片打印機（價值$1,219）🔥🔥" 
      },
      { 
        category: "現金套現分期（無簽賬要求）", 
        totalRate: 0, 
        baseRate: 0, 
        extraRate: 0, 
        note: "高達 **$100,000** 之 **6個月免息免手續費** 現金套現分期計劃" 
      },
    ],
    minSpend: {
      amount: 4000,
      period: "promo",
      note: "發卡後90個曆日內簽賬（sim Credit Card: $4,000 / sim World Mastercard®: $8,000）",
    },
    exclusions: [
      "現金透支、信用卡費用及收費（年費、利息、逾期費用等）",
      "繳付稅項、政府機構款項",
      "保險公司繳款、慈善捐款",
      "購買禮券/現金券、單位信託/基金供款",
      "賭場交易",
      "電子錢包增值/轉賬（支付寶、微信支付、PayMe等）",
      "八達通增值（包括自動增值）",
      "FPS轉賬、分期付款",
      "取消/退款/未記賬交易",
    ],
    warnings: [
      "📌 **簽賬期**：發卡後 **90個曆日** 內",
      "📌 申請時須選擇迎新獎賞類別，**選定後不可更改**",
      "📌 未指定獎賞類別將預設為現金回贈",
      "⚠️ 申請時及過去 **12個月內** 未持有任何發卡機構信用卡主卡",
      "⚠️ 申請時及過去 **24個月內** 未使用發卡機構任何貸款或信貸服務",
      "⚠️ 發卡後 **13個月內** 取消卡會扣除迎新獎賞等值金額",
      "📋 獎賞先到先得，送完即止",
    ],
    officialSource: "https://cdn.thesim.com/24_Terms_and_Conditions_of_Welcome_Offer_TC_R2_78a74d748e.pdf",
    lastUpdated: "2026-01-08",
  },

  // ========================================================================
  // sim Credit Card 現金回贈優惠
  // 來源：https://cdn.thesim.com/88_sim_Credit_Card_Terms_and_Conditions_of_Cash_Back_Promotion_TC_Nov25_Jan26_b385a392c8.pdf
  // ========================================================================
  {
    cardId: "sim-credit-card-cashback",
    cardName: "sim Credit Card 現金回贈優惠",
    bank: "亞洲聯合財務",
    applicableCards: [
      { cardId: "sim-credit-card", cardName: "sim Credit Card" },
    ],
    documentName: "sim Credit Card 現金回贈優惠條款及細則",
    promoStartDate: "2025-11-01",
    promoEndDate: "2026-01-31",
    rewardRates: [
      { 
        category: "合資格網上零售簽賬（單筆≥$500）", 
        totalRate: 8, 
        baseRate: 0.4, 
        extraRate: 7.6, 
        note: "港幣或外幣網上零售簽賬 **8%** 🔥🔥（需每月非網上簽賬滿$1,000）" 
      },
      { 
        category: "指定本地公共交通工具", 
        totalRate: 8, 
        baseRate: 0.4, 
        extraRate: 7.6, 
        note: "城巴/九巴/龍運/港鐵/電車/天星小輪 **8%** 🔥🔥（需每月非網上簽賬滿$1,000）" 
      },
      { 
        category: "指定商戶本地簽賬", 
        totalRate: 3, 
        baseRate: 0.4, 
        extraRate: 2.6, 
        note: "Adidas/PUMA/@cosme STORE/Fila/松本清/東京生活館 **3%**（需每月非網上簽賬滿$1,000）" 
      },
      { 
        category: "其他合資格零售簽賬", 
        totalRate: 0.4, 
    ...
    minSpend: {
      amount: 1000,
      period: "monthly",
      note: "每月累積合資格非網上零售簽賬滿$1,000方可享8%/3%回贈",
    },
    rewardCap: {
      type: "total",
      amount: 200,
      period: "monthly",
      note: "每月最高$200，整個優惠期最高$600",
    },
    exclusions: [
      "現金透支、信用卡費用及收費",
      "繳付稅項、政府機構款項",
    ...
    warnings: [
      "📌 **每月門檻**：非網上零售簽賬滿 **$1,000** 方可享8%/3%回贈",
      "📌 **每月上限**：$200",
      "📌 **優惠期總上限**：$600",
      "📌 指定交通工具：城巴、九巴、龍運、港鐵（拍卡出入閘）、電車、天星小輪",
      "📌 指定商戶：Adidas、PUMA、@cosme STORE、Fila、松本清、東京生活館",
      "⚠️ 網上簽賬須單筆滿 **$500** 方可享8%",
    ],
    officialSource: "https://cdn.thesim.com/88_sim_Credit_Card_Terms_and_Conditions_of_Cash_Back_Promotion_TC_Nov25_Jan26_b385a392c8.pdf",
    lastUpdated: "2026-01-08",
  },

  // ========================================================================
  // sim World Mastercard® 現金回贈優惠
  // 來源：http://cdn.thesim.com/89_sim_World_Mastercard_Terms_and_Conditions_of_Cash_Back_TC_Nov25_Jan26_f2bd742eda.pdf
  // ========================================================================
  {
    cardId: "sim-world-mastercard-cashback",
    cardName: "sim World Mastercard® 現金回贈優惠",
    bank: "亞洲聯合財務",
    applicableCards: [
      { cardId: "sim-world-mastercard", cardName: "sim World Mastercard®" },
    ],
    documentName: "sim World Mastercard® 現金回贈優惠條款及細則",
    promoStartDate: "2025-11-01",
    promoEndDate: "2026-01-31",
    rewardRates: [
      { 
      ...
      { 
        ...
        baseRate: 0.4, 
        extraRate: 7.6, 
        note: "港幣以外貨幣海外簽賬 **8%** 🔥🔥（需每月非網上簽賬滿$1,000）" 
      },
      { 
        category: "指定商戶本地簽賬", 
        totalRate: 3, 
    ...
    warnings: [
      ...
      "📌 指定商戶：Adidas、PUMA、@cosme STORE、Fila、松本清、東京生活館",
      "⚠️ 網上簽賬須單筆滿 **$500** 方可享8%",
      "⚠️ 海外網上簽賬會被歸類為網上簽賬（非海外簽賬）",
    ],
    officialSource: "http://cdn.thesim.com/89_sim_World_Mastercard_Terms_and_Conditions_of_Cash_Back_TC_Nov25_Jan26_f2bd742eda.pdf",
    lastUpdated: "2026-01-08",
  },

  // ========================================================================
  // Citi 八達通信用卡車費回贈推廣
  // 來源：https://www.citibank.com.hk/chinese/credit-cards/pdf/octopus-cards/terms-and-conditions.pdf
  // ========================================================================
  {
    cardId: "citi-octopus-transport-rebate",
    cardName: "Citi 八達通信用卡車費回贈推廣",
    bank: "花旗銀行",
    applicableCards: [
      { cardId: "citi-octopus-platinum", cardName: "Citi 八達通白金卡" },
      { cardId: "citi-octopus-visa", cardName: "Citi 八達通 Visa 卡" },
    ],
    documentName: "15%港鐵、巴士、渡輪、綠色專線小巴、電車、的士車費及5%隧道、泊車及電車充電收費回贈推廣條款及細則",
    promoStartDate: "2025-10-01",
    promoEndDate: "2026-03-31",
    rewardRates: [
      { 
        category: "車費回贈（簽$4,000門檻）", 
        totalRate: 15, 
        baseRate: 0, 
        extraRate: 15, 
        note: "港鐵/巴士/渡輪/綠色專線小巴/電車/的士 **15%** 🔥🔥🔥（每月上限$300）" 
      },
      { 
        category: "車費+隧道等回贈（簽$10,000門檻）", 
        totalRate: 0, 
        baseRate: 0, 
        extraRate: 0, 
        note: "車費 **15%** + 隧道/泊車/電車充電 **5%** 🔥🔥🔥（每月上限$500）" 
      },
    ],
    minSpend: {
      amount: 4000,
      period: "monthly",
      note: "每月Citi信用卡合資格簽賬$4,000享15%車費回贈；$10,000享車費+隧道等回贈",
    },
    rewardCap: {
      type: "total",
      amount: 300,
      period: "monthly",
      note: "簽$4,000：每月最高$300 / 簽$10,000：每月最高$500",
    },
    exclusions: [
      "動態貨幣兌換交易（外幣轉港幣）",
      "八達通自動增值/手機增值（如Apple Pay）",
      "結餘轉賬、折現計劃",
      "分期計劃金額（賬單/簽賬分期、Quick Cash）",
      "Pay All服務",
      "繳稅、繳費、公共事務費用",
      "自動轉賬、循環付款",
      "基金供款、銀行手續費、保險費",
    ...
    warnings: [
      "📌 **需登記**：citibank.hk/transreg（已登記過往車費回贈推廣者自動登記）",
      "📌 **合資格簽賬**：所有 Citi 信用卡本地及海外零售簽賬、商戶分期、現金透支",
      "📌 **指定公共交通**：",
      "   🚇 港鐵（所有路線含機場快綫、輕鐵）",
      "   🚌 巴士（城巴、九巴、龍運）",
      "   ⛴️ 渡輪（新渡輪、天星小輪、港九小輪）",
      "   🚐 綠色專線小巴、🚃 電車",
      "   🚕 的士（$24-$500，每日每八達通最多2次）",
      "📌 **指定隧道/泊車/充電**：易通行增值、停車場/咪錶、電車充電",
      "⚠️ **不合資格車費**：港鐵客務中心購物、頭等/超時附加費、城際直通車",
      "⚠️ **的士限制**：單筆$24-$500、每日每八達通最多2次",
    ],
  ...
  // ========================================================================
  // 滙豐 easy 信用卡/滙豐白金 Visa 信用卡精選優惠
  // 來源：https://www.hsbc.com.hk/content/dam/hsbc/hk/tc/docs/credit-cards/visa-platinum-card-exclusive-offers.pdf
  // ========================================================================
  {
    cardId: "hsbc-easy-moneyback-offers",
    cardName: "滙豐 easy 信用卡/滙豐白金 Visa 信用卡精選優惠",
    bank: "滙豐",
    applicableCards: [
      { cardId: "hsbc-easy", cardName: "滙豐 easy 信用卡" },
      { cardId: "hsbc-visa-platinum", cardName: "滙豐白金 Visa 信用卡" },
    ],
    documentName: "滙豐 easy 信用卡/滙豐白金 Visa 信用卡精選優惠條款及細則",
    promoStartDate: "2025-05-19",
    promoEndDate: "2026-12-31",
    rewardRates: [
      { 
        category: "百佳/屈臣氏/豐澤「易賞錢」積分（VIP會員）", 
        totalRate: 6, 
        baseRate: 1, 
        extraRate: 5, 
        note: "VIP會員 **6倍** 易賞錢積分 🔥🔥 / 普通會員 **4倍**" 
      },
      { 
        category: "百佳/PNS 會員日 92折", 
        totalRate: 0.92, 
        baseRate: 0, 
        extraRate: 0, 
        note: "每月2、12、22日 **8%折扣**（實體店滿$100/PNS滿$800），每日上限$64 🔥" 
      },
      { 
        category: "屈臣氏會員日 92折", 
        totalRate: 0.92, 
        baseRate: 0, 
        extraRate: 0, 
        note: "每月8、18、28日 **8%折扣**（滿$400），每日上限$40 🔥" 
      },
      { 
        category: "豐澤會員日 95折", 
        totalRate: 0.95, 
        baseRate: 0, 
        extraRate: 0, 
        note: "1月、5月、8月、12月的10日 **5%折扣**（滿$2,000），每日上限$100" 
      },
    ],
    exclusions: [
      "禮券/電子禮券、初生嬰兒奶粉、香煙",
      "電話卡/儲值卡/禮品卡",
      "電子錢包增值及簽賬（PayMe、WeChat Pay、支付寶）",
      "中國內地及澳門分店簽賬",
      "取消/退款/未誌賬交易",
      "蘋果產品、遊戲電玩產品（豐澤）",
      "自助收銀機、點購站交易（屈臣氏）",
    ...
    warnings: [
      "📌 **需連結**：合資格信用卡至「易賞錢」手機應用程式賬戶",
      "📌 **百佳會員日**：每月 **2、12、22日**（實體店滿$100 / PNS滿$800）",
      "📌 **屈臣氏會員日**：每月 **8、18、28日**（滿$400）",
      "📌 **豐澤會員日**：1月、5月、8月、12月的 **10日**（滿$2,000）",
      "📌 **免費送貨**：PNS/屈臣氏網店/豐澤網店 每年各4次",
      "📌 **生日禮遇**：百佳滿$250免費送貨 / 屈臣氏滿$450減$50 / 豐澤滿$1,000減$100",
      "📌 **免費專業服務**：屈臣氏中醫門診免診金、彩妝服務",
    ],
    officialSource: "https://www.hsbc.com.hk/content/dam/hsbc/hk/tc/docs/credit-cards/visa-platinum-card-exclusive-offers.pdf",
    lastUpdated: "2026-01-08",
  },

  // ========================================================================
  // 滙豐 easy 信用卡迎新推廣優惠 - 「易賞錢」VIP 會籍
  // 來源：https://www.hsbc.com.hk/content/dam/hsbc/hk/tc/docs/credit-cards/offers/p7-acq-offer-tnc.pdf
  // ========================================================================
  {
    cardId: "hsbc-easy-welcome-vip",
    cardName: "滙豐 easy 信用卡迎新推廣優惠 - 「易賞錢」VIP 會籍",
    bank: "滙豐",
    applicableCards: [
      { cardId: "hsbc-easy", cardName: "滙豐 easy 信用卡" },
    ],
    documentName: "滙豐 easy 信用卡迎新推廣優惠 - 「易賞錢」VIP 會籍條款及細則",
    promoStartDate: "2025-05-18",
    promoEndDate: "2026-06-30",
    rewardRates: [
      { 
        category: "迎新：1年「易賞錢」VIP 會籍", 
        totalRate: 0, 
        baseRate: 0, 
        extraRate: 0, 
        note: "發卡後首30日內綁定易賞錢App → 獲 **1年VIP會籍** 🔥🔥" 
      },
      { 
        category: "VIP會籍權益：百佳/屈臣氏/豐澤 6倍積分", 
        totalRate: 6, 
        baseRate: 1, 
        extraRate: 5, 
        note: "VIP會員於百佳/屈臣氏/豐澤消費享 **6倍** 易賞錢積分" 
      },
    ],
    warnings: [
      "📌 發卡後首 **30個曆日內** 綁定滙豐 easy 信用卡至「易賞錢」App",
      "📌 VIP會籍於完成條件後 **4個月內** 生效",
      "📌 VIP權益：百佳/屈臣氏/豐澤消費享 **6倍** 易賞錢積分",
      "⚠️ 批核日起計過去 **12個月內** 曾取消任何滙豐個人信用卡者不適用",
      "⚠️ 開戶後 **13個月內取消卡** 或 **取消綁定** 會取消VIP會籍",
      "⚠️ 附屬卡申請人不適用",
    ],
    officialSource: "https://www.hsbc.com.hk/content/dam/hsbc/hk/tc/docs/credit-cards/offers/p7-acq-offer-tnc.pdf",
    lastUpdated: "2026-01-08",
  },

  // ========================================================================
  // Citi HKTVmall 信用卡一般條款及細則
  // 來源：https://www.citibank.com.hk/chinese/credit-cards/hktvmall-card/
  // ========================================================================
  {
    cardId: "citi-hktvmall-general",
    cardName: "Citi HKTVmall 信用卡一般條款及細則",
    bank: "Citi",
    applicableCards: [
      { cardId: "citi-hktvmall", cardName: "Citi HKTVmall 信用卡" },
    ],
    documentName: "Citi HKTVmall 信用卡一般條款及細則",
    rewardRates: [
      { 
        category: "基本積分", 
        totalRate: 1, 
      ...
      { 
        ...
        baseRate: 1, 
        extraRate: 4, 
        note: "每簽賬 $1 = **5分** 積分（基本1分+額外4分）🔥🔥" 
      },
      { 
        category: "📅 星期四 HKTVmall 5%折扣", 
        totalRate: 0.95, 
        baseRate: 0, 
        extraRate: 0, 
        note: "透過 Citi HKTVmall 信用卡支付平台簽賬享 **5%折扣** 🔥" 
      },
    ],
    rewardCap: {
      type: "extra",
    ...
    exclusions: [
      ...
      "保險費用、慈善/非牟利機構交易",
      "轉數快交易",
      "Citi HKTVmall 信用卡支付平台簽賬（不獲積分）",
      "HKTV Pay 簽賬",
      "未誌賬/已取消/已退款/偽造/未經授權交易",
    ],
    warnings: [
      "📌 **星期一**：每$1獲 **5分**（基本1分+額外4分），上限每月50,000分",
      "📌 **星期四**：透過 Citi HKTVmall 信用卡支付平台簽賬享 **5%折扣**（需輸入優惠碼）",
      "📌 積分 **不設期限** ✨",
      "📌 積分換領只適用於 **基本卡客戶**",
      "⚠️ **PayAll 計劃** 不適用獎勵積分",
      "⚠️ **5%折扣不適用**：HKTVmall電子禮券、一號嬰兒奶粉、Apple產品、iTunes禮品卡、網絡遊戲點數卡、999金器",
      "⚠️ Citi HKTVmall 支付平台簽賬 **不經信用卡協會處理**，無 VISA 退款保障",
    ],
  ...
  // ========================================================================
  // 渣打 A. Point Card 獎賞條款（與AlipayHK合作）
  // 來源：https://av.sc.com/hk/content/docs/hk-cc-apointcard-rewards-tnc.pdf
  //       https://av.sc.com/hk/content/docs/hk-cc-apointcard-luckydraw-tnc.pdf
  //       https://av.sc.com/hk/content/docs/hk-cc-apointcard-bonski-mar25.pdf
  // ========================================================================
  {
    cardId: "sc-a-point-card",
    cardName: "渣打 A. Point Card 獎賞條款",
    bank: "渣打銀行",
    applicableCards: [
      { cardId: "sc-a-point-card", cardName: "渣打 A. Point Card" },
    ],
    documentName: "A. Point Card 獎賞條款及細則",
    promoStartDate: "2025-12-01",
    promoEndDate: "2026-11-30",
    rewardRates: [
      { 
        category: "🌏 AlipayHK跨境簽賬（中國大陸/海外）", 
        totalRate: 20, 
        baseRate: 2, 
        extraRate: 18, 
        note: "每$1 = **20 A. Point** 🔥🔥🔥（約**2%回贈**，以1000:1計）" 
      },
      { 
        category: "📱 AlipayHK其他合資格簽賬", 
        totalRate: 2, 
        baseRate: 2, 
        extraRate: 0, 
        note: "每$1 = **2 A. Point**（約0.2%回贈）" 
      },
      { 
        category: "💳 實體卡/電子錢包零售簽賬", 
        totalRate: 10, 
        baseRate: 0, 
        extraRate: 10, 
        note: "每$1 = **10 A. Point** 🔥🔥（約**1%回贈**）" 
      },
    ],
    rewardCap: {
      type: "total",
      amount: 600000,
      period: "quarterly",
      note: "AlipayHK額外A. Point：每活動期最高600,000 | 基本A. Point：單月最高500,000",
    },
    exclusions: [
      "電子錢包增值（八達通銀包、支付寶等）",
      "快速支付系統（轉數快）交易",
      ...
      "現金透支、結餘轉賬、兌現分期",
      "繳稅、財務費用",
      "AlipayHK轉賬、匯款、信用卡還款、物業管理費",
      "AlipayHK增值、轉賬、還款等非消費類交易",
    ],
    warnings: [
      "📌 **迎新獎賞**（至2026/1/31）：透過AlipayHK App申請 → **$1,000禮券**（三個月單單低至$1優惠）",
      "📌 **迎新大抽獎**（至2026/1/31）：人人有賞，隨機抽取$20-$20,000禮券",
      "📌 **AlipayHK跨境簽賬**：每$1 = **20 A. Point** 🔥🔥🔥",
      "📌 **實體卡/電子錢包**：每$1 = **10 A. Point** 🔥🔥",
      "📌 **A. Point兌換**：1000 A. Point = $1抵扣（指定場景）| 100 A. Point = $1（購買優惠券）",
      "📌 **A. Point有效期**：每季結算，需於季度結束後一個月內使用",
      "📌 **淘寶免手續費**：每月指定次數免手續費（其後1.5%）",
      "📌 **AlipayHK轉賬**：每月高達$1,000免手續費限額（其後1.5%）",
      "⚠️ 迎新只適用於 **全新信用卡客戶**（過去6個月內沒有取消渣打/MANHATTAN信用卡）",
      "⚠️ 必須透過 **AlipayHK App** 申請才可享迎新獎賞",
      "⚠️ 禮券有效期 **90天**，過期失效不補發",
    ],
