...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    type: "guide",
    title: "💻 外幣網購信用卡排行榜 2026｜淨賺最高5%",
    description: "外幣網購邊張卡最抵？扣除手續費後邊張淨賺最多？Amazon、iHerb、訂閱服務最佳信用卡比較！",
    imageUrl: "https://images.unsplash.com/photo-1563013544-824ae1b704d3?q=80&w=2070&auto=format&fit=crop",
    tags: ["外幣網購", "排行榜", "Amazon", "iHerb", "2026"],
    merchant: "攻略",
    isNew: true,
  },
  {
    ...
    type: "guide",
    title: "網購信用卡攻略｜港幣 vs 外幣網購完整指南",
    description: "網購信用卡基礎攻略！港幣網購 vs 外幣網購有咩分別？外幣手續費點計？Apple Pay 網購有回贈嗎？",
