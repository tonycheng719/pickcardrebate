...
export const MERCHANT_CATEGORIES: MerchantCategory[] = [
  ...
  },
  {
    ...
    merchants: [
      ...
      { id: 'pacific_coffee', name: 'Pacific Coffee', category: 'dining', aliases: ['太平洋咖啡'] },
      { id: 'kkc', name: 'KFC 肯德基', category: 'dining', aliases: ['肯德基', 'kfc'] },
      { id: 'genki_sushi', name: '元氣壽司', category: 'dining', aliases: ['元氣', 'genki'] },
      { id: 'yoshinoya', name: '吉野家', category: 'dining', aliases: ['yoshinoya'] },
      { id: 'fairwood', name: '大快活', category: 'dining', aliases: ['fairwood'] },
  ...
  },
  {
    ...
    icon: '✈️',
    merchants: [
      { id: 'cathay', name: '國泰航空', category: 'travel', aliases: ['cathay', '國泰'] },
      { id: 'hkexpress', name: 'HK Express', category: 'travel', aliases: ['香港快運'] },
      { id: 'klook', name: 'Klook', category: 'travel', aliases: ['客路'] },
      { id: 'kkday', name: 'KKday', category: 'travel', aliases: [] },
      { id: 'trip_com', name: 'Trip.com', category: 'travel', aliases: ['攜程', 'ctrip'] },
      { id: 'agoda', name: 'Agoda', category: 'travel', aliases: [] },
      { id: 'booking', name: 'Booking.com', category: 'travel', aliases: [] },
  ...
  },
  {
    ...
    merchants: [
      ...
      { id: 'apple_store', name: 'Apple Store', category: 'online', aliases: ['app store', 'itunes'] },
      { id: 'google_play', name: 'Google Play', category: 'online', aliases: [] },
    ],
  },
  {
    id: 'transport',
  ...
  },
  {
    ...
    merchants: [
      ...
      { id: 'disney_plus', name: 'Disney+', category: 'entertainment', aliases: ['disney'] },
      ...
      { id: 'playstation', name: 'PlayStation', category: 'entertainment', aliases: ['ps', 'psn'] },
    ],
  },
  {
    id: 'government',
  ...
  },
  {
    ...
    merchants: [
      ...
      { id: 'alipay', name: 'AlipayHK', category: 'ewallet', aliases: ['支付寶', 'alipay'] },
      { id: 'wechat_pay', name: 'WeChat Pay HK', category: 'ewallet', aliases: ['微信支付'] },
      { id: 'tap_go', name: 'Tap & Go', category: 'ewallet', aliases: ['拍住賞'] },
    ],
  },
  {
    id: 'electronics',
